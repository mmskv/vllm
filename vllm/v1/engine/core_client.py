...
class InprocClient(EngineCoreClient):
    ...
    def sleep(
        ...
        result = self.engine_core.sleep(level, storage_tier, mode)
...
class SyncMPClient(MPClient):
    ...
    def sleep(
        ...
        self.call_utility("sleep", level, storage_tier, mode)
...
class AsyncMPClient(MPClient):
    ...
    async def sleep_async(
        ...
        await self.call_utility_async("sleep", level, storage_tier, mode)
